...
german = Field(tokenize=tokenizer_eng, lower=True,
...
train_data, validation_data, test_data = Multi30k.splits(
    exts=(".me", ".pde"), fields=(german, english)
)
...
# used to include (, max_size=500, min_freq=1)
...
save_model = True
load_model = False # so long as I am loading up old epochs
